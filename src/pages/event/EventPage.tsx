...
import Participants from "@/pages/event/components/participants/Participants.tsx";
import PhotosGallery from "@/pages/event/components/photos/PhotosGallery.tsx";
import {useEventPage} from '@/hooks/api/useEventPage.ts';
import {useGetProfileQuery} from "@/services/api/profileApi.ts";
import EventChat from '@/pages/event/components/chat/EventChat.tsx';
import ArchivedEventOverview from '@/pages/event/components/archived-overview/ArchivedEventOverview.tsx';
import EventTasksOverview from '@/pages/event/components/tasks-overview/EventTasksOverview.tsx';
